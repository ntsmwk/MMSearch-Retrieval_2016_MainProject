...
/**
 * Represents the color naming histogram of a given image. 
 * The colorHistogram consists of the relative values for the 11 colors - 
 * black, blue, brown, grey, green, oragne, pink, purple, red, white, yellow.
 * 
 * @author Markus
 *
 */
