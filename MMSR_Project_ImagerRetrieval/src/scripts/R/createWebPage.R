...
# set up web page
target <- HTMLInitFile(file.path("/home/alina/Documents/Universität/2016W/Multimedia Search and Retrieval/Project/MMSearch-Retrieval_2016_MainProject/MMSR_Project_ImagerRetrieval/src/scripts","webinterface"),"index", BackGroundColor="#DDDDDD")
