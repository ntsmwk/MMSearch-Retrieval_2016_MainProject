...
# set up web page
target <- HTMLInitFile(file.path("/home/alina/Documents/Universität/2016W/Multimedia Search and Retrieval/Project/MMSearch-Retrieval_2016_MainProject/MMSR_Project_ImagerRetrieval/src/scripts/relevantimages","webinterface"),"index", BackGroundColor="#DDDDDD")
...
# load actual data
filepath <- "/home/alina/Documents/Universität/2016W/Multimedia Search and Retrieval/Project/MMSearch-Retrieval_2016_MainProject/MMSR_Project_ImagerRetrieval/src/scripts/retrievedImages.csv"
